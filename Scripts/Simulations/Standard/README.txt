...
3. The input to run these files are 4 vectors (one for all: Alpha, Llif, L11, L33) with parameters to be checked.
4. These vectors are used as input in the RUNMUL.m file. 